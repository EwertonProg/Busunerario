...
class PontoMapActivity : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    lateinit var roteiro: LatLng

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ponto_map)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val parada = roteiro
        mMap.addMarker(MarkerOptions().position(parada))
